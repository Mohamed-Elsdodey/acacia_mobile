...
class ChildernInfo extends StatefulWidget {
  const ChildernInfo({super.key, required this.childernInfo});
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      fit: BoxFit.cover,
                      image: NetworkImage(widget.childernInfo.image!)),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          widget.childernInfo.room!.title!,
                          style: const TextStyle(
                              fontWeight: FontWeight.w400, fontSize: 12),
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          widget.childernInfo.schoolRank.toString(),
                          style: const TextStyle(
                              fontWeight: FontWeight.w400, fontSize: 12),
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          widget.childernInfo.rowRank.toString(),
                          style: const TextStyle(
                              fontWeight: FontWeight.w400, fontSize: 12),
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          widget.childernInfo.roomRank.toString(),
                          style: const TextStyle(
                              fontWeight: FontWeight.w400, fontSize: 12),
                        ),
                      ],
              ...
              children: [
                ...
                PositionedDirectional(
                    ...
                    child: CircleAvatar(
                      ...
                      child: Center(
                        child: Text(
                          widget.childernInfo.newNotificationCount.toString(),
                          style: const TextStyle(
